...
function printPDF() {
  ...
  sty.textContent = [
    ...
    '.cp-members-table td { text-align: center; padding: 1px 10px; vertical-align: middle; font-size: 12pt; line-height: 1.35; font-family: "Times New Roman", Times, serif; }',
    '.cp-members-table .row-name td { font-size: 12pt; font-weight: 700; font-family: "Times New Roman", Times, serif; }',
    '.cp-members-table .row-id   td,',
    '.cp-members-table .row-sess td { font-size: 12pt; font-weight: 400; font-family: "Times New Roman", Times, serif; line-height: 1.4; padding: 1px 6px; text-align: center; }',
    '.spacer { flex: 1; }',
